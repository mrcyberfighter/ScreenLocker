...
|                                                                              |
| 1) Rollers: rollers who roll horizontaly or verticaly throught the screen    |
|              available in:                                                   |
|                                                                              |
|              -) 3 different size:                                            |
|                 -> Little.                                                   |
...
|                 -> Yellow.                                                   |
|                                                                              |
| 2) Bars:    bars mesh whose colors can be set in the value you want, or in   |
|             random colors setting what fill the screen with multicolors      |
|             bars, available in:                                              |
|                                                                              |
|              -) 2 different mode:                                            |
|                 -> Rectangles mode                                           |
...
|                                                                              |
|                   !!! To reset the field od the filename to None you must    |
